...
building it from the ground up and then using it to solve the Brachistochrone Problem itself, as well as the history of the problem from Galileo to Newton and the Bernoulli Brothers.
